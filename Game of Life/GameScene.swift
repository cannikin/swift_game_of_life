...
class GameScene: SKScene {
  ...
  override func didMoveToView(view: SKView) {
    ...
    _populationLabel.fontName = "Menlo"
    ...
    _generationLabel.fontName = "Menlo"
    ...
    // population number label
    _populationValueLabel.position = CGPoint(x: 79, y:175)
    _populationValueLabel.fontName = "Menlo"
    ...
    _generationValueLabel.fontName = "Menlo"
